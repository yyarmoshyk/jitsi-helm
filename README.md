...
[![Artifact Hub](https://img.shields.io/endpoint?url=https://artifacthub.io/badge/repository/jitsi-meet)](https://artifacthub.io/packages/search?repo=jitsi-meet) ![GitHub Release](https://img.shields.io/github/v/release/yyarmoshyk/jitsi-helm?logo=helm&logoColor=white&label=Latest%20release)
 ![GitHub Release Date](https://img.shields.io/github/release-date/yyarmoshyk/jitsi-helm?display_date=published_at&logo=git&logoColor=white&label=Released%20at)
...
```bash
helm repo add yyjitsi https://yyarmoshyk.github.io/jitsi-helm/
helm install myjitsi yyjitsi/jitsi-meet
```
